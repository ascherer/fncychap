...
\enlargethispage{2cm}
  \chapter{A simple example}
    ...
    respectively. Finally, The functions
    \A{FmN}\texttt{\textbraceleft~\textbraceright} and
    \A{FmTi}\texttt{\textbraceleft~\textbraceright} acts accordingly
    to \A{Ch***AsIs}, \A{Ch***UpperCase} and
